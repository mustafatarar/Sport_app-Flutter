      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            style: TextStyle(
             ...
             SizedBox(height: 4,),
              Text("Tap * to follow one or more Player ,These will appear in your Faveriotes tab",
            style: TextStyle(
              fontFamily: "inter",
              fontWeight: FontWeight.w400,
       ...
       height: size.height*0.090,
         ...
         children: [
           CircleAvatar(
             radius: 20,
             backgroundImage: AssetImage('assets/images/Rolnaldo.jpeg'),
           ),
    ...
    color: Color(0xffFFFFFF)
       ...
       height: size.height*0.090,
         ...
         children: [
            CircleAvatar(
             radius: 20,
             backgroundImage: AssetImage('assets/images/salah.jpeg'),
           ),
